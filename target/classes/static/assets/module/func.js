!function (t) {
    ...
    layui.define(["form", "layer", "table", "common", "treeTable"], (function (t) {
        "use strict";
        var e, n, a, i, o, r = layui.form, l = layui.table, c = layui.layer, u = layui.common, d = layui.treeTable,
            f = layui.$, s = 0, h = 0, m = !1, b = {
                tableIns: function (t, r, d = null, b = "", p = !1) {
                    n = r, a = d, b && "" != b || (b = cUrl + "/list");
                    var y = f("#param").val();
                    ...
                    return e = l.render({
                        ...
                        loading: !0,
                            ...
                            if (o) {
                                ...
                                a.children("tr").on("dblclick", (function () {
                                    var e = a.find(".layui-table-hover").data("index"), n = t.data[e];
                                    u.edit(i, n.id, s, h)
                                }))
                            }
                        }
                        ...
                        var e = t.value, n = t.data, a = t.field, i = {};
                        i.id = n.id, i[a] = e;
                        var o = JSON.stringify(i), r = JSON.parse(o), l = cUrl + "/update";
                        u.ajaxPost(l, r, (function (t, e) {
                        }), "更新中...")
                    ...
                    var b = d.render({
                        ...
                        height: "full-50",
                        cellMinWidth: 80,
                        tree: {iconIndex: 1, idName: "id", pidName: r || "pid", isPidData: !0},
                        cols: [t],
                        done: function (t, e, n) {
                            c.closeAll("loading")
                        },
        ...
        u.verify(), r.on("submit(submitForm)", (function (t) {
            ...
            switch (f(this).attr("lay-event")) {
                case"add":
                    ...
                    break;
                case"batchDrop":
                    (o = {title: "批量删除"}).url = cUrl + "/batchDelete", o.data = t, o.confirm = !0, o.type = "GET", u.batchFunc(o, (function () {
                        e.reload()
                    }));
                    break;
                case"batchCache":
                    ...
                    break;
                case"batchEnable":
                    (o = {title: "批量启用状态"}).url = cUrl + "/batchStatus", o.param = a, o.data = t, o.form = "submitForm", o.confirm = !0, o.show_tips = "处理中...", o.type = "POST", u.batchFunc(o, (function () {
                        e.reload()
                    }));
                    break;
                case"batchDisable":
                    (o = {title: "批量禁用状态"}).url = cUrl + "/batchStatus", o.param = a, o.data = t, o.confirm = !0, o.show_tips = "处理中...", o.type = "POST", u.batchFunc(o, (function () {
                        e.reload()
                    }));
                    break;
                case"export":
                    var a = [], o = f(".layui-form-item [name]").serializeArray();
                    f.each(o, (function () {
                        a.push(this.name + "=" + this.value)
                    })), (o = {title: "导出数据"}).url = cUrl + "/export", o.data = t, o.confirm = !0, o.type = "POST", o.show_tips = "数据准备中...", o.param = a, u.batchFunc(o, (function (t, e) {
